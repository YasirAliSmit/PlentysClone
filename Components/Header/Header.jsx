                ...
                <View>
                    ...
                    <View>
                        <View style={{ flexDirection: 'row', marginTop: responsiveHeight(2.5) }} >
                            ...
                            <View style={{ width: responsiveWidth(40), height: responsiveHeight(20), backgroundColor: '#0B223F', zIndex: 1, marginLeft: responsiveWidth(2.5), marginRight: responsiveWidth(3), borderRadius: responsiveWidth(1) }}><Image style={styles.khi} source={require('../assets/karachi.png')} /><TouchableOpacity onPress={()=>setCity(true)}><Text style={styles.karachiTxt}>Karachi</Text></TouchableOpacity></View>

                            <View style={{ width: responsiveWidth(40), height: responsiveHeight(20), backgroundColor: '#617186', zIndex: 1, borderRadius: responsiveWidth(1) }}><Image style={styles.khi} source={require('../assets/lahore.png')} /><TouchableOpacity onPress={()=>setCity(false)} ><Text  style={styles.lahoreTxt} >Lahore</Text></TouchableOpacity></View>
                        </View>
                    </View>
                </View>
